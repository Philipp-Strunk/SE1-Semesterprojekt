...
public class CommandHandler {
	...
	public void startEingabe()  {
		...
		while ( true ) {
			...
			command.execute(); // ggf. Fehlerhandling notwendig, Parameter-Übergabe

			// Historie (ggf. eine Kopie
			// Clones eines Command-Objektes hinzufügen, um das Mememto abzuspeichern.
